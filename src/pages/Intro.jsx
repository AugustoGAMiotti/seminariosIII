        ...
        <div>
            <p>
                ...
                <h2>
                    ...
                    Libras não é uma tradução direta do português. É uma língua própria com gramática, sintaxe e vocabulário próprios.
                    Assim como outras línguas de sinais, Libras tem estruturas diferentes da linguagem falada ou escrita.
                    <br />
                    Regionalismos:
                    Embora seja utilizada em todo o Brasil, como português, Libras também pode apresentar variações regionais, como diferenças em alguns sinais dependendo da região.
                    <br />
                    Alfabeto Manual:
                    Para soletrar nomes próprios ou palavras que não têm um sinal específico, utiliza-se o alfabeto manual, que representa cada letra do alfabeto com uma configuração específica das mãos.
                    <br />
                    Expressões Faciais e Corporais:
                    Além dos sinais feitos com as mãos, a expressão facial e os movimentos corporais são essenciais para transmitir emoções, intensidades e contextos.
                </h2>
            </p>
        </div>
    );
